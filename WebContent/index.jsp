...
<div id="layoutHeader">
	...
	<dl class="xtJbHcb">
		<dd class="vyQHNyb">
		<span class="cMEMEF">
		<a href = "main/init.do" style="color:#09AAFF;">我的文件</a>
		</span>
		<span class="cMEMEF">
...
<div class="uyiLGWX">
	<div class="OFaPaO">
	<div class="oclLlDK">
	<form action="main/search.do" method="post" class="rodJJ7 nqlj1aPp">
		<input type="text" name="filename" class="klzvyY8g" placeholder="搜索您的文件"/>
		<span class="gHHsaL">
	...
	<a title="上传" class="g-button" href="upload.jsp">
...
<div class="file-name" style="width:60%">
	...
	<div style="display:none;width:100%;height:100%;z-index:30;position:absolute;top:0;left:0;"></div>
		<a class="g-button" style="display: inline-block;" href="share/create.do?key=<%=fileforusr.getUfileid() %>">分享</a>
		<a class="g-button" style="display: inline-block;" href="file/download.do?key=<%=fileforusr.getUfileid() %>">下载</a>
		<a class="g-button" style="display: inline-block;" href="main/del.do?key=<%=fileforusr.getUfileid() %>">删除</a>
	</div>
	</div>
</div>

<div class="wsbdJ7D" style="width:16%"><%=fileforusr.getUsize() %></div>
<div class="pdgbd47Z" style="width:23%"><%=fileforusr.getUploadtime() %></div>
